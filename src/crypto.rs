...
/// Derives a 32-byte encryption key from a passphrase using BLAKE3.
...
pub fn write_signing_key_to_file(
    ...
    // Generate a random nonce for XChaCha20Poly1305 encryption
    ...
    // Create XChaCha20Poly1305 cipher instance
...
mod tests {
    ...
    fn decrypt_with_wrong_passphrase_fails() {
        ...
        let temp_path = PathBuf::from("/tmp/decrypt_wrong_pass_key.json");
